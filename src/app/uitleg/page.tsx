    ...
    <div className="mx-auto flex w-full max-w-4xl flex-col gap-8 px-4 py-10">
      ...
      <section className="space-y-4 rounded-3xl border border-white/10 bg-slate-900/60 p-6">
        ...
        <ul className="space-y-3 text-sm text-slate-300">
          ...
          <li>
            <span className="font-semibold text-white">22:15:</span> nog geen nieuwe cijfers aangeleverd; de 21:15-stand blijft zichtbaar tot de volgende push van Ipsos I&O.
          </li>
      </ul>
      </section>
